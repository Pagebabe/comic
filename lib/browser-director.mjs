...
export function localCommandReply(message) {
  ...
  switch (command) {
    ...
    case '/characters':
      return { reply: 'Text-Canon 4/4 gesperrt: Ricco (24, ländlicher DJ-Neuling), Basti Prenzl (44, weicher Ex-Linker-Vermieter), Jule (29, Plenum-/Küchenmacht) und Don Miau (alte wortlose Bosskatze). Erweiterungsbibliothek: 13 frühe Figuren, 9 Character Production Sheets und 6 LoRA Training Sheets. Offen sind nur visuelle Masterreferenzen, drei Stimmenbeispiele und Don Miaus Fellpalette.' };
    case '/plan':

...
export function diagnoseFailure(input = {}) {
  ...
  if (!rule) {
    return Object.freeze({
      ...
      steps: Object.freeze(['Stoppe die Ausführung.', 'Sichere Logs und betroffene Artefakte.', 'Eskalation an einen Menschen.']),
      automaticActionAllowed: false,
      humanRequired: true,
      decision: 'HUMAN_ESCALATION_REQUIRED',
      retry: null,
      planHash: hash({ code: code || 'UNKNOWN', decision: 'HUMAN_ESCALATION_REQUIRED' })
    });
  }

...
for (const marker of ['data-testid="ricco-master-review"', 'EXECUTION BLOCKED', 'data-testid="ricco-source-count"', 'data-testid="ricco-candidate-count"', 'candidateCount', 'candidateLimit', 'data-testid="ricco-review-status"', 'humanDecision.current', 'data-testid="ricco-review-tests"', 'data-testid="ricco-zero-state"']) if (!riccoView.includes(marker)) throw new Error(`Ricco review marker missing: ${marker}`);

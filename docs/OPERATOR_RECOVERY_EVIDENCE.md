...
Ausgangspunkt ist der nach PR #120 veröffentlichte Main-Commit:

```text
837290dfa7edf89114915b84248526ed570fbe51
```

Das Production Cockpit und seine Tests bleiben vollständig erhalten. Die einzige inhaltliche Überschneidung war `package.json`; dort werden Cockpit- und Recovery-Testketten gemeinsam geführt.
...
Dieser Lauf ist keine terminale Evidence für den neuen, auf PR #120 basierenden Head. Der finale Head benötigt frische grüne Läufe von `Operator Recovery Drill` und `Comic Factory CI`.
...
- [x] Production Cockpit aus PR #120 erhalten

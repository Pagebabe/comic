...
Die Testperson darf Browser und normale Desktop-Anwendungen bedienen. Sie soll nicht an Comic Factory mitgearbeitet haben und die interne Gate-Struktur vorher nicht kennen.

## Beobachter

Der Beobachter greift nur ein, wenn Sicherheit oder Datenverlust droht oder die Testperson ausdrücklich Hilfe anfordert. Jede Hilfe wird notiert. Undokumentierte Hilfe macht die Abnahme ungültig.

import { BookOpen, Boxes, Captions, Clapperboard, Film, Gauge, ListChecks, Map, MonitorPlay, PenTool, ScrollText, ShieldCheck, Sparkles, Workflow, Wand2 } from 'lucide-react';

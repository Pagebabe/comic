...
export function RiccoImport() {
  ...
  const packageLooksValid = Boolean(parsedPackage?.packageVersion || parsedPackage?.reviewState || parsedPackage?.panels);
  ...
  return (
    <section className="page-stack">
      <div className={packageLooksValid ? 'hero-card' : 'hero-card warning-card'}>
        <p className="eyebrow">Ricco Package Import v0.1</p>
        <h2>Production Package wiederherstellen</h2>
        <p className="body-copy">
          Füge ein vorher exportiertes Ricco Production Package JSON ein. Die Seite stellt die gespeicherten Bildvarianten und Finalbild-Auswahl im Browser wieder her.
        </p>
        <div className="chips">
        ...
        <div className="review-actions">
          <button className="primary-button" onClick={restoreImages}>Bilder wiederherstellen</button>
      ...
      <div className="grid two-col">
        <section className="card rule-card">
          ...
          <ul>
            ...
            <li>Bilder wiederherstellen klicken.</li>
            <li>Danach Ricco Image Review, Export oder Lettering öffnen.</li>
          </ul>
        </section>
